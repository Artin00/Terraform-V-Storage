...
resource "azurerm_storage_account_network_rules" "NetWorkRules1" { # This resource creates the network policy for the storage account created above
  storage_account_id         = azurerm_storage_account.Storaccount1.id
  default_action             = "Deny"
